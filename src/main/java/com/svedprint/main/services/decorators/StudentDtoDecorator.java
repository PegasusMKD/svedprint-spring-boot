...
public class StudentDtoDecorator extends StudentDto {
	...
	public StudentDto init(Student entity) {
		...
		// TODO: Implement maturska
		maturska = null;
		List<Integer> tmpGrades = Collections.nCopies(entity.getSubjectOrientation().getSubjects().size(), 0);
		List<Integer> tmpDroppedGrades = Collections.nCopies(entity.getSubjectOrientation().getSubjects().size(), 0);
